...
// Função para obter a capital do estado por sigla
...
document.getElementById('searchForm').addEventListener('submit', function (event) {
    ...
    const capital = getCapitalEstado(input);
    if (capital) {
        document.getElementById('capitalInfo').innerHTML = `<p>Capital: ${capital}</p>`;
    } else {
        document.getElementById('capitalInfo').innerHTML = "<p>Estado não encontrado.</p>";
    }
});