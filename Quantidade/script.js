...
function fetchStateCount() {
    ...
    // Contar o número de estados
    const stateCount = estadosCidades.estados.length;

    // Exibir o número de estados na página
    document.getElementById('stateCount').textContent = `Total States: ${stateCount}`;
}